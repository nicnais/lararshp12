            ...
            <div class="col-md-8">
                <div class="card card-warning">
                    <div class="card-header">
                        <h3 class="card-title">Form Edit Kode Tindakan</h3>
                    </div>
                    ...
                    <form action="{{ route('admin.kode-tindakan-terapi.update', $data->idkode_tindakan_terapi) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="deskripsi_tindakan_terapi" class="form-control" value="{{ old('deskripsi_tindakan_terapi', $data->deskripsi_tindakan_terapi) }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="idkategori" class="form-select" required>
                                    @foreach($kategori as $kat)
                                        <option value="{{ $kat->idkategori }}" {{ $data->idkategori == $kat->idkategori ? 'selected' : '' }}>
                                            {{ $kat->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="idkategori_klinis" class="form-select" required>
                                    @foreach($kategori_klinis as $klinis)
                                        <option value="{{ $klinis->idkategori_klinis }}" {{ $data->idkategori_klinis == $klinis->idkategori_klinis ? 'selected' : '' }}>
