...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Kode Tindakan & Terapi</h3></div>
            <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @forelse ($kode_tindakan_terapi as $index => $item)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.kode-tindakan-terapi.destroy', $item->idkode_tindakan_terapi) }}" method="POST" style="display:inline;" onsubmit="return confirm('Hapus data ini?');">
                                            @csrf
                                            @method('DELETE')
