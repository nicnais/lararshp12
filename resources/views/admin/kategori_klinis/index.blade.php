                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @forelse ($kategori_klinis as $index => $item)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.kategori-klinis.destroy', $item->idkategori_klinis) }}" method="POST" style="display:inline;" onsubmit="return confirm('Hapus data ini?');">
                                            @csrf
                                            @method('DELETE')
